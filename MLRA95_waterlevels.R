...
#Set up
#API Token: You will need your own API token: https://www.ncdc.noaa.gov/cdo-web/token
noaa_api_token <- "GUiUTATbcmFRUpoTsGPFVujGfZyYogLW"
# henry info
...
henry_coords <- data.frame(id = henry_sensor_name, coordinates(x$sensors[x$sensors$name == henry_sensor_name, ]))
